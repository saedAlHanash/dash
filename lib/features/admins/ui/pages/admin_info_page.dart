  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: BlocListener<DriverBuIdCubit, DriverBuIdInitial>(
          listenWhen: (p, c) => c.statuses.done,
          listener: (context, state) {
            setState(() => request = CreateAdminRequest.fromAdmin(state.result));
          },
          child: Column(
              ...
              MyCardWidget(
                ...
                child: Column(
                  children: [
                    ...
                    BlocBuilder<DriverBuIdCubit, DriverBuIdInitial>(
                      builder: (context, state) {
                        ...
                        return Builder(
                          builder: (context) {
                            final list = request.roleNames
                                .map((e) =>
                                SpinnerItem(name: e, isSelected: true, enable: false))
                                .toList();
