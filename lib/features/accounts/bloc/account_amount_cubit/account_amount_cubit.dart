...
//     final response =
//     await APIService().callApi(type: ApiType.get,url: GetUrl.fromDriver, query: {'driverId': driverId});
//
//     final response1 =
//     await APIService().callApi(type: ApiType.get,url: GetUrl.fromCompany, query: {'driverId': driverId});
//
