...
class CompanyTransfersFilterWidget extends StatefulWidget {
  const CompanyTransfersFilterWidget({super.key, this.onApply, this.command});
  ...
  @override
  State<CompanyTransfersFilterWidget> createState() =>
      _CompanyTransfersFilterWidgetState();
}

class _CompanyTransfersFilterWidgetState extends State<CompanyTransfersFilterWidget> {
