...
class AttendancesFilterWidget extends StatefulWidget {
  ...
  final Function(FilterAttendancesRequest request)? onApply;
...
class _AttendancesFilterWidgetState extends State<AttendancesFilterWidget> {
  late FilterAttendancesRequest request;
  ...
  @override
  void initState() {
    request = widget.command?.historyRequest ?? FilterAttendancesRequest();
