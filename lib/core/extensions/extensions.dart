...
import 'package:qareeb_models/trip_process/data/response/trip_response.dart'; import '../../features/redeems/data/response/redeems_response.dart';
...
// import 'package:qareeb_models/trip_process/data/response/trip_response.dart'; import '../../features/trip/data/response/trip_response.dart';
...
extension NormalTripMap on TripResult {
  ...
  List<MyMarker> get getMarkers {
    return [
      MyMarker(point: startPoint, type:
      MyMarkerType.sharedPint),
      MyMarker(point: endPoint, type: MyMarkerType.sharedPint),
    ];
  }
